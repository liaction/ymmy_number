...
import 'package:ymwy_number/flutter_colorpicker/utils.dart';
                      ...
                      child: (_orientation == Orientation.portrait &&
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  AnimatedOpacity(
                                    ...
                                    opacity:
                                        _currentShading == _color ? 1.0 : 0.0,
                                    child: Icon(
                                      Icons.done,
                                      color: useWhiteForeground(_color)
                                          ? Colors.white
                          ...
                          : Container(
                              child: AnimatedOpacity(
                                duration: const Duration(milliseconds: 210),
                                opacity: _currentShading == _color ? 1.0 : 0.0,
                                child: Icon(
                                  Icons.done,
                                  color: useWhiteForeground(_color)
                                      ? Colors.white
      ...
      case Orientation.landscape:
        return Container(
          ...
          child: Column(
            children: <Widget>[
              Container(
                height: _height / 4 / 4 * 2.5,
                child: _shadingList(),
              ),
              Container(
                height: _height / 4 / 4 * 1.5,
                child: _colorList(),
              ),
            ],
          ),
